...
IF NOT EXISTS (SELECT * 
    ...
    EXEC sp_addextendedproperty 'MS_Description', 'Identificador unico de la tabla', 'Schema', 'dbo', 'table', 'Stock_Status', 'column', 'Id';

-- Descripci�n para la columna Status_Name
IF NOT EXISTS (SELECT * 
...
-- Descripci�n para la columna Key
IF NOT EXISTS (SELECT * 
